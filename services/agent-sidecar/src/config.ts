...
/** Parsed provider config from models.yml as it appears on disk */
...
/**
 * Load all models from ~/.omp/agent/models.yml.
 */
...
/**
 * Load default model role config from ~/.omp/agent/config.yml.
 */
...
/**
 * Build a pi-catalog Model object from a loaded model definition.
 */
...
/**
 * Resolve a model role string like "sensenova/mimo-v2.5" into a LoadedModel
 * by matching provider/model_id.
 */
