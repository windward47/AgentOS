...
function defaultConfig(): CompanionConfig {
    return {
        ...
        custom_system_prompt: [
            ...
            "Make responses speakable by TTS. Convert math (5x²→five X squared), symbols, numbers to spoken form. Avoid markdown in spoken content.",
            "You can use emotion tags: [happy], [sad], [angry], [surprised], [shy], [fear], [joy].",
        ].join("\n\n"),
        live2d_model: "haru",
